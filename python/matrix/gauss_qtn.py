...
def main():
    ...
    try:
        ...
        print("Loi: Khong the mo duoc file!")
        return
    ...
    print(f"Ma tran doc duoc co {total_cols} cot.")

    cols_b = -1
    while cols_b < 1 or cols_b >= total_cols:
        cols_b = int(input(f"Nhap so cot cua ma tran B (tu 1 den {total_cols - 1}): "))
